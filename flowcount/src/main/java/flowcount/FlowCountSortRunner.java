...
//			conf.set("mapreduce.job.jar", "flow");
			job = Job.getInstance(conf,"flowcountsortjob");
	...
	public static class FlowCountMapper extends Mapper<LongWritable, Text, FlowBean, NullWritable>{
		
		FlowBean flowBeanSort = new FlowBean();
		...
		protected void map(LongWritable key, Text value,
			...
			flowBeanSort.set(mobile,up_flow, down_flow);
			
			context.write( flowBeanSort,NullWritable.get());
		}
//		@Override
...
//		}
	...
	public static class FlowCountReducer extends Reducer<FlowBean,NullWritable,Text,FlowBean>{
...
//		}
		...
		protected void reduce(FlowBean key, Iterable<NullWritable> arg1,
			...
			context.write(new Text(key.getMobile()), key);
		}
	}
}
